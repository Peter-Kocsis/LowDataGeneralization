...
from lowdataregime.classification.model._network.efficientnet_utils import (
    round_filters,
    round_repeats,
    drop_connect,
...
class EfficientNetBackbone(nn.Module):
    """
    EfficientNet-based architecture only for feature extraction i.e., without last fully-connected layer
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # Stem
        in_channels = 3  # rgb
        self.out_channels = round_filters(32, self._global_params)  # number of output channels
        self._conv_stem = Conv2d(in_channels, self.out_channels, kernel_size=3, stride=2, bias=False)
        self._bn0 = nn.BatchNorm2d(num_features=self.out_channels, momentum=bn_mom, eps=bn_eps)
    ...
    def from_name(cls, model_name, in_channels=3, **override_params):
        ...
        Args:
            ...
            override_params (other key word params):
                ...
                Optional key:
                    'width_coefficient', 'depth_coefficient',neurips_supervised
    ...
    def _change_in_channels(self, in_channels):
        ...
        if in_channels != 3:
            ...
            self.out_channels = round_filters(32, self._global_params)
            self._conv_stem = Conv2d(in_channels, self.out_channels, kernel_size=3, stride=2, bias=False)


VALID_MODELS = (
    'efficientnet-b0', 'efficientnet-b1', 'efficientnet-b2', 'efficientnet-b3', 'efficientnet-b3_small',
